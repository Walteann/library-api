...
public class BookControllerTest {
        ...
        @Test
        @DisplayName("Deve lançar error ao tentar cadastrar um livro com isb já utilizado por outro.")
        public void createBookWithDuplicatedIsbn() throws Exception {
                ...
                BDDMockito.given(service.save(Mockito.any(Book.class))).willThrow(new BussinessException(messageError));
        ...
        @Test
        @DisplayName("Deve retornar resource not found quando o livro procurado não exisitir")
        ...
        public void updateBookTest() throws Exception {
                ...
                Book book = Book.builder().author("Artur").title("As Aventuras").isbn("001").build();
        ...
        @Test
        @DisplayName("Deve retornar 404 ao tentar atualizar atualizar um livro inexistente")
